...
public class Solution {
	...
	static HashSet<String> map = new HashSet<>(); // This global variable stores all the unique solution for the N
													// queens problem
	...
	public static void checkForAttack(int[][] matrix, HashSet<Integer> d1, HashSet<Integer> d2, HashSet<Integer> v,
			int row) {
	...
	// This function adds the solution to the set of solutions if it already does
	// not exists.
